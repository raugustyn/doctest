...
if __name__ == "__main__":
    for projectFileName in getQGISProjectsInPath("C:/ms4w/Apache/htdocs/Generalizace/TB04CUZK001_TestDataSets_Daniela/", "Kompozice.qgs"):
        print projectFileName
        (situationId, minX, minY, maxX, maxY, width, height, imageFileName) = getImageParams(projectFileName)
        print (situationId, minX, minY, maxX, maxY, width, height, imageFileName)
